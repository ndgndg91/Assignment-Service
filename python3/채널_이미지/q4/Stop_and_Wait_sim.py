...
MSS = 512  #number of bytes
seqNSpaceSize = 2  #size of the packet sequence number space
lossProb = 20 #packet loss probability in %
delayProb = 0 #packet delay probability in %
